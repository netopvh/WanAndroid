...
@ActivityScope
public class ProjectChildPresenter extends BasePresenter<ProjectChildCot.Model, ProjectChildCot.View> {

    @Inject
    RxErrorHandler mErrorHandler;

    @Inject
    public ProjectChildPresenter(ProjectChildCot.Model model, ProjectChildCot.View rootView) {
    ...
    public void getListById(int cid, int page) {
        mModel.queryListById(cid, page)
