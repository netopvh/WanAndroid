...
import com.whamu2.wanandroid.BuildConfig;
...
public class GlobalConfiguration implements ConfigModule {
    ...
    private static String sDomain = Api.APP_DOMAIN;
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https,详情请百度
                    ...
                    okhttpBuilder.cookieJar(new AppCookie()); /// 持久化cookie
